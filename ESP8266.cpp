...
bool ESP8266::registerUDP(String addr, uint32_t port, uint32_t my_port)
{
    return sATCIPSTARTSingle("UDP", addr, port, my_port);
}
...
bool ESP8266::sATCIPSTARTSingle(String type, String addr, uint32_t port, uint32_t my_port)
{
    String data;
    rx_empty();
    m_puart->print("AT+CIPSTART=\"");
